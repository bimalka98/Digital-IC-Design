...
// Generated on: Dec 22 2022 09:54:22 +0530 (Dec 22 2022 04:24:22 UTC)
...
module sampling_tick_generator_BAUD115200_CLOCK_IN_MHZ100(clk, reset,
     start, tick_16_8, tick_16_16, dft_sen);
  input clk, reset, start, dft_sen;
  output tick_16_8, tick_16_16;
  wire clk, reset, start, dft_sen;
  ...
  SDFFQX1 \counter_reg[9] (.CK (clk), .D (n_32), .SI (counter[8]), .SE
       (dft_sen), .Q (counter[9]));
...
module
  ...
  wire [7:0] data_parallel_out;
  wire rx_buffer_full, parity_error, stop_bit_error, dft_sdo;
  ...
  rx_fsm_NO_OF_DATA_BITS8_PARITY_ENABLED32h54525545_PARITY_TYPE24h4f4444_NO_OF_STOP_BITS1
       ...
       (sampling_tick_middle), .sampling_tick_end (dft_sdo),
...
module
  ...
  input clk, reset, uart_hw_rx_pin, tx_data_wr_enable_in,
       rx_data_rd_enable_in, dft_sdi, dft_sen;
  ...
  tx_wrapper_NO_OF_WORDS_IN_BUFFER1_NO_OF_DATA_BITS8_PARITY_ENABLED32h54525545_PARITY_TYPE24h4f4444_NO_OF_STOP_BITS1_BAUD115200_CLOCK_IN_MHZ100
       ...
       (uart_hw_tx_pin), .dft_sdi (n_28), .dft_sen (dft_sen));
endmodule
...
module uart_top(clk_a, reset_a, tx_parallel_data_in_a,
     ...
     rx_stop_bit_error_b, SE, scan_in_a, scan_out_a, scan_in_b,
     scan_out_b);
  ...
  output tx_busy_out_a, rx_full_a, rx_parity_error_a,
       ...
       rx_parity_error_b, rx_stop_bit_error_b, scan_out_a, scan_out_b;
  ...
  uart_transceiver_CLOCK_IN_MHZ100_TX_WORD_LENGTH8_TX_NO_OF_WORDS1_RX_WORD_LENGTH8_RX_NO_OF_WORDS1
       ...
       .uart_hw_rx_pin (scan_out_b), .uart_hw_tx_pin (scan_out_a),
       ...
       .rx_stop_bit_error (rx_stop_bit_error_a), .dft_sdi (scan_in_a),
       .dft_sen (SE));
  uart_transceiver_CLOCK_IN_MHZ100_TX_WORD_LENGTH8_TX_NO_OF_WORDS1_RX_WORD_LENGTH8_RX_NO_OF_WORDS1_1
       ...
       .uart_hw_rx_pin (scan_out_a), .uart_hw_tx_pin (scan_out_b),
       ...
       .rx_stop_bit_error (rx_stop_bit_error_b), .dft_sdi (scan_in_b),
       .dft_sen (SE));
endmodule
