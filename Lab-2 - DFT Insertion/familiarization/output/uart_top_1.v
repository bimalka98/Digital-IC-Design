...
// Generated on: Dec 22 2022 09:54:20 +0530 (Dec 22 2022 04:24:20 UTC)
...
module rx_buffer_WORD_SIZE8_NO_OF_WORDS1(clk, reset, data_serial_wr_en,
  ...
  SDFFQX2 \buffer_full_counter_reg[1] (.CK (clk), .D (n_33), .SI
       (buffer_full_counter[1]), .SE (1'b0), .Q
  ...
  SDFFQX1 \buffer_full_counter_reg[0] (.CK (clk), .D (n_32), .SI
       (buffer_full_counter[0]), .SE (1'b0), .Q
  ...
  SDFFHQX8 \data_parallel_out_reg[2] (.CK (clk), .D (n_24), .SI (n_43),
       .SE (1'b0), .Q (n_43));
  SDFFQX1 \memory_reg[0] (.CK (clk), .D (n_23), .SI (memory[0]), .SE
       (1'b0), .Q (memory[0]));
  SDFFHQX8 \data_parallel_out_reg[0] (.CK (clk), .D (n_26), .SI (n_41),
       .SE (1'b0), .Q (n_41));
  SDFFHQX8 \data_parallel_out_reg[1] (.CK (clk), .D (n_25), .SI (n_42),
       .SE (1'b0), .Q (n_42));
  SDFFHQX8 \data_parallel_out_reg[7] (.CK (clk), .D (n_15), .SI (n_48),
       .SE (1'b0), .Q (n_48));
  SDFFHQX8 \data_parallel_out_reg[3] (.CK (clk), .D (n_27), .SI (n_44),
       .SE (1'b0), .Q (n_44));
  SDFFHQX8 \data_parallel_out_reg[4] (.CK (clk), .D (n_22), .SI (n_45),
       .SE (1'b0), .Q (n_45));
  SDFFHQX8 \data_parallel_out_reg[5] (.CK (clk), .D (n_21), .SI (n_46),
       .SE (1'b0), .Q (n_46));
  MXI2XL g738__7675(.A (n_0), .B (n_11), .S0 (buffer_full_counter[0]),
       .Y (n_30));
  SDFFHQX8 \data_parallel_out_reg[6] (.CK (clk), .D (n_20), .SI (n_47),
       .SE (1'b0), .Q (n_47));
  SDFFQX1 \memory_reg[3] (.CK (clk), .D (n_19), .SI (memory[3]), .SE
       (1'b0), .Q (memory[3]));
  SDFFQX1 \memory_reg[4] (.CK (clk), .D (n_14), .SI (memory[4]), .SE
       (1'b0), .Q (memory[4]));
  SDFFQX1 \memory_reg[5] (.CK (clk), .D (n_13), .SI (memory[5]), .SE
       (1'b0), .Q (memory[5]));
  SDFFQX1 \memory_reg[2] (.CK (clk), .D (n_16), .SI (memory[2]), .SE
       (1'b0), .Q (memory[2]));
  SDFFQX1 \memory_reg[7] (.CK (clk), .D (n_12), .SI (memory[7]), .SE
       (1'b0), .Q (memory[7]));
  SDFFQX1 \memory_reg[6] (.CK (clk), .D (n_18), .SI (memory[6]), .SE
       (1'b0), .Q (memory[6]));
  SDFFQX1 \memory_reg[1] (.CK (clk), .D (n_17), .SI (memory[1]), .SE
       (1'b0), .Q (memory[1]));
  ...
  MX2X1 g756__2703(.A (memory[3]), .B (memory[4]), .S0 (n_1), .Y
       (n_19));
  MX2X1 g757__5795(.A (memory[6]), .B (memory[7]), .S0 (n_1), .Y
       (n_18));
  ...
  MX2X1 g762__9906(.A (memory[5]), .B (memory[6]), .S0 (n_1), .Y
       (n_13));
  MX2X1 g763__8780(.A (memory[7]), .B (data_serial_in), .S0 (n_1), .Y
       (n_12));
  ...
  MXI2XL g772__2900(.A (n_48), .B (memory[7]), .S0
...
module
  ...
  SDFFHQX8 parity_error_reg(.CK (clk), .D (n_59), .SI (n_62), .SE
       (1'b0), .Q (n_62));
  SDFFHQX4 \state_reg[0] (.CK (clk), .D (n_60), .SI (state[0]), .SE
       (1'b0), .Q (state[0]));
  SDFFQX1 \data_bit_counter_reg[2] (.CK (clk), .D (n_57), .SI
       (data_bit_counter[2]), .SE (1'b0), .Q (data_bit_counter[2]));
  SDFFQX4 stop_bit_error_reg(.CK (clk), .D (n_58), .SI (n_61), .SE
       (1'b0), .Q (n_61));
  ...
  SDFFQX1 \data_bit_counter_reg[1] (.CK (clk), .D (n_56), .SI
       (data_bit_counter[1]), .SE (1'b0), .Q (data_bit_counter[1]));
  NOR2X1 g2809__5953(.A (reset), .B (n_51), .Y (n_58));
  SDFFQX2 \data_bit_counter_reg[0] (.CK (clk), .D (n_53), .SI
       (data_bit_counter[0]), .SE (1'b0), .Q (data_bit_counter[0]));
  ...
  SDFFQX1 data_out_to_buffer_reg(.CK (clk), .D (n_49), .SI
       (data_out_to_buffer), .SE (1'b0), .Q (data_out_to_buffer));
  SDFFQX1 data_valid_to_buffer_reg(.CK (clk), .D (n_50), .SI
       (data_valid_to_buffer), .SE (1'b0), .Q (data_valid_to_buffer));
  SDFFHQX4 \state_reg[2] (.CK (clk), .D (n_48), .SI (state[2]), .SE
       (1'b0), .Q (state[2]));
  SDFFHQX4 \state_reg[1] (.CK (clk), .D (n_44), .SI (state[1]), .SE
       (1'b0), .Q (state[1]));
  ...
  SDFFQX1 parity_reg(.CK (clk), .D (n_47), .SI (parity), .SE (1'b0), .Q
       (parity));
  ...
  SDFFQX1 tick_start_reg(.CK (clk), .D (n_41), .SI (tick_start), .SE
       (1'b0), .Q (tick_start));
  ...
  NOR3X2 g2858__9906(.A (sampling_tick_middle), .B (state[2]), .C
       (n_3), .Y (n_17));
  ...
  NAND2BX1 g2866__2683(.AN (state[2]), .B (sampling_tick_middle), .Y
       (n_8));
...
module sampling_tick_generator_BAUD115200_CLOCK_IN_MHZ100(clk, reset,
  ...
  wire n_65;
  SDFFQX1 tick_16_16_reg(.CK (clk), .D (n_36), .SI (tick_16_16), .SE
       (1'b0), .Q (tick_16_16));
  ...
  OAI2BB1X1 g872__1786(.A0N (counter[5]), .A1N (n_61), .B0 (n_65), .Y
       (n_34));
  NAND2X2 g873__5953(.A (counter[4]), .B (counter[5]), .Y (n_65));
  NAND2X1 g874__5703(.A (counter[8]), .B (counter[9]), .Y (n_33));
  OR2X1 g875__7114(.A (counter[3]), .B (counter[2]), .Y (n_61));
  SDFFQX1 \counter_reg[9] (.CK (clk), .D (n_32), .SI (counter[9]), .SE
       (1'b0), .Q (counter[9]));
  SDFFQX1 \counter_reg[8] (.CK (clk), .D (n_31), .SI (counter[8]), .SE
       (1'b0), .Q (counter[8]));
  ...
  ADDHX1 g1420__2703(.A (counter[8]), .B (n_25), .CO (n_28), .S (n_29));
  SDFFQX1 \counter_reg[7] (.CK (clk), .D (n_27), .SI (counter[7]), .SE
       (1'b0), .Q (counter[7]));
  NOR3BX1 g1422__5795(.AN (n_26), .B (reset), .C (n_1), .Y (n_27));
  SDFFQX1 \counter_reg[5] (.CK (clk), .D (n_24), .SI (counter[5]), .SE
       (1'b0), .Q (counter[5]));
  ADDHX1 g1424__7344(.A (counter[7]), .B (n_19), .CO (n_25), .S (n_26));
  SDFFQX1 \counter_reg[6] (.CK (clk), .D (n_23), .SI (counter[6]), .SE
       (1'b0), .Q (counter[6]));
  NOR3X1 g1426__1840(.A (reset), .B (n_21), .C (n_1), .Y (n_24));
  SDFFQX1 \counter_reg[4] (.CK (clk), .D (n_22), .SI (counter[4]), .SE
       (1'b0), .Q (counter[4]));
  ...
  ADDHX1 g1446__7675(.A (counter[1]), .B (counter[0]), .CO (n_4), .S
       (n_5));
  SDFFQX1 \counter_reg[0] (.CK (clk), .D (n_2), .SI (counter[0]), .SE
       (1'b0), .Q (counter[0]));
...
module sampling_tick_generator_BAUD115200_CLOCK_IN_MHZ100_1(clk, reset,
  ...
  assign tick_16_16 = 1'b0;
  SDFFQX1 \counter_reg[9] (.CK (clk), .D (n_37), .SI (counter[9]), .SE
       (1'b0), .Q (counter[9]));
  SDFFQX1 \counter_reg[8] (.CK (clk), .D (n_36), .SI (counter[8]), .SE
       (1'b0), .Q (counter[8]));
  ...
  SDFFQX1 \counter_reg[7] (.CK (clk), .D (n_32), .SI (counter[7]), .SE
       (1'b0), .Q (counter[7]));
  NOR3BX1 g1463__6083(.AN (n_31), .B (reset), .C (n_0), .Y (n_32));
  SDFFQX1 \counter_reg[5] (.CK (clk), .D (n_29), .SI (counter[5]), .SE
       (1'b0), .Q (counter[5]));
  ADDHX1 g1465__2703(.A (counter[7]), .B (n_23), .CO (n_30), .S (n_31));
  SDFFQX1 \counter_reg[6] (.CK (clk), .D (n_27), .SI (counter[6]), .SE
       (1'b0), .Q (counter[6]));
  NOR3X1 g1467__5795(.A (reset), .B (n_25), .C (n_0), .Y (n_29));
  SDFFQX2 tick_16_8_reg(.CK (clk), .D (n_28), .SI (tick_16_8), .SE
       (1'b0), .Q (tick_16_8));
  SDFFQX1 \counter_reg[4] (.CK (clk), .D (n_26), .SI (counter[4]), .SE
       (1'b0), .Q (counter[4]));
  ...
  SDFFQX1 \counter_reg[3] (.CK (clk), .D (n_18), .SI (counter[3]), .SE
       (1'b0), .Q (counter[3]));
  NOR4BX1 g1478__3772(.AN (counter[7]), .B (counter[0]), .C
       (counter[6]), .D (n_11), .Y (n_19));
  NOR3BX1 g1479__1474(.AN (n_15), .B (reset), .C (n_0), .Y (n_18));
  SDFFQX1 \counter_reg[1] (.CK (clk), .D (n_13), .SI (counter[1]), .SE
       (1'b0), .Q (counter[1]));
  SDFFQX1 \counter_reg[2] (.CK (clk), .D (n_12), .SI (counter[2]), .SE
       (1'b0), .Q (counter[2]));
  NOR2BX1 g1482__4547(.AN (n_16), .B (n_3), .Y (n_17));
  SDFFQX1 \counter_reg[0] (.CK (clk), .D (n_14), .SI (counter[0]), .SE
       (1'b0), .Q (counter[0]));
...
module tx_buffer_WORD_SIZE8_NO_OF_WORDS1(clk, reset, data_parallel_in,
  ...
  SDFFQX1 \buffer_empty_counter_reg[1] (.CK (clk), .D (n_35), .SI
       (buffer_empty_counter[1]), .SE (1'b0), .Q
       (buffer_empty_counter[1]));
  SDFFQX1 \memory_reg[7] (.CK (clk), .D (n_34), .SI (memory[7]), .SE
       (1'b0), .Q (memory[7]));
  SDFFQX1 \buffer_empty_counter_reg[0] (.CK (clk), .D (n_33), .SI
       (buffer_empty_counter[0]), .SE (1'b0), .Q
  ...
  SDFFQX1 \memory_reg[2] (.CK (clk), .D (n_28), .SI (memory[2]), .SE
       (1'b0), .Q (memory[2]));
  SDFFQX1 \memory_reg[1] (.CK (clk), .D (n_30), .SI (memory[1]), .SE
       (1'b0), .Q (memory[1]));
  SDFFQX1 \memory_reg[0] (.CK (clk), .D (n_29), .SI (memory[0]), .SE
       (1'b0), .Q (memory[0]));
  SDFFQX1 \memory_reg[3] (.CK (clk), .D (n_24), .SI (memory[3]), .SE
       (1'b0), .Q (memory[3]));
  SDFFQX1 \memory_reg[4] (.CK (clk), .D (n_26), .SI (memory[4]), .SE
       (1'b0), .Q (memory[4]));
  AO22X1 g1302__1840(.A0 (n_18), .A1 (memory[7]), .B0
  ...
  SDFFQX1 \memory_reg[5] (.CK (clk), .D (n_27), .SI (memory[5]), .SE
       (1'b0), .Q (memory[5]));
  SDFFQX1 \memory_reg[6] (.CK (clk), .D (n_23), .SI (memory[6]), .SE
       (1'b0), .Q (memory[6]));
  ...
  SDFFQX1 data_serial_out_reg(.CK (clk), .D (n_19), .SI
       (data_serial_out), .SE (1'b0), .Q (data_serial_out));
  ...
  AOI22X1 g1327__7114(.A0 (data_parallel_in[6]), .A1 (n_2), .B0
       (memory[7]), .B1 (data_serial_rd_enable), .Y (n_11));
...
module
  ...
  SDFFHQX4 buffer_rd_enable_reg(.CK (clk), .D (n_68), .SI
       (buffer_rd_enable), .SE (1'b0), .Q (buffer_rd_enable));
  ...
  SDFFQX1 delay_data_parallel_wr_enable_reg(.CK (clk), .D
       (data_parallel_wr_enable), .SI (delay_data_parallel_wr_enable),
       .SE (1'b0), .Q (delay_data_parallel_wr_enable));
  SDFFQX1 parity_reg(.CK (clk), .D (n_80), .SI (parity), .SE (1'b0), .Q
       (parity));
  SDFFHQX4 \state_reg[0] (.CK (clk), .D (n_78), .SI (state[0]), .SE
       (1'b0), .Q (state[0]));
  SDFFHQX4 \state_reg[1] (.CK (clk), .D (n_56), .SI (state[1]), .SE
       (1'b0), .Q (state[1]));
  SDFFHQX4 \state_reg[2] (.CK (clk), .D (n_76), .SI (state[2]), .SE
       (1'b0), .Q (state[2]));
  SDFFHQX4 \state_reg[3] (.CK (clk), .D (n_53), .SI (state[3]), .SE
       (1'b0), .Q (state[3]));
  SDFFQX1 tem_buffer_data_reg(.CK (clk), .D (n_79), .SI
       (tem_buffer_data), .SE (1'b0), .Q (tem_buffer_data));
  SDFFQX1 tick_start_reg(.CK (clk), .D (n_71), .SI (tick_start), .SE
       (1'b0), .Q (tick_start));
  SDFFHQX8 tx_busy_reg(.CK (clk), .D (n_63), .SI (n_81), .SE (1'b0), .Q
       (n_81));
  SDFFQX1 tx_data_reg(.CK (clk), .D (n_73), .SI (tx_data), .SE (1'b0),
       .Q (tx_data));
...
module
  ...
  wire data_serial_out, data_serial_rd_enable, empty,
       sampling_tick_end, sampling_tick_middle, tick_start;
  ...
  tx_fsm_NO_OF_DATA_BITS8_PARITY_ENABLED32h54525545_PARITY_TYPE24h4f4444_NO_OF_STOP_BITS1
       ...
       (1'b0), .tick_start (tick_start), .data_parallel_wr_enable
       (data_parallel_wr_enable), .tx_busy (tx_busy), .tx_data
       (tx_data), .buffer_rd_enable (data_serial_rd_enable),
...
module rx_buffer_WORD_SIZE8_NO_OF_WORDS1_1(clk, reset,
  ...
  MX2X1 g756__1474(.A (memory[3]), .B (memory[4]), .S0 (n_1), .Y
       (n_19));
  MX2X1 g757__4547(.A (memory[6]), .B (memory[7]), .S0 (n_1), .Y
       (n_18));
  ...
  MX2X1 g762__2900(.A (memory[5]), .B (memory[6]), .S0 (n_1), .Y
       (n_13));
  MX2X1 g763__2391(.A (memory[7]), .B (data_serial_in), .S0 (n_1), .Y
       (n_12));
  ...
  MXI2XL g771__5266(.A (n_45), .B (memory[4]), .S0
       (data_parallel_rd_enable), .Y (n_4));
  MXI2XL g772__2250(.A (n_48), .B (memory[7]), .S0
       (data_parallel_rd_enable), .Y (n_3));
...
module
  ...
  NOR3X2 g2858__2900(.A (sampling_tick_middle), .B (state[2]), .C
       (n_3), .Y (n_17));
  ...
  NAND2BX1 g2866__5703(.AN (state[2]), .B (sampling_tick_middle), .Y
       (n_8));
...
module sampling_tick_generator_BAUD115200_CLOCK_IN_MHZ100_2(clk, reset,
  ...
  OAI2BB1X1 g872__1840(.A0N (counter[5]), .A1N (n_61), .B0 (n_65), .Y
       (n_34));
  NAND2X2 g873__5019(.A (counter[4]), .B (counter[5]), .Y (n_65));
  NAND2X1 g874__1857(.A (counter[8]), .B (counter[9]), .Y (n_33));
  ...
  ADDHX1 g1420__1474(.A (counter[8]), .B (n_25), .CO (n_28), .S (n_29));
  SDFFQX1 \counter_reg[7] (.CK (clk), .D (n_27), .SI (counter[7]), .SE
       (1'b0), .Q (counter[7]));
  ...
  AOI31X1 g1440__5703(.A0 (counter[8]), .A1 (counter[7]), .A2 (n_7),
       .B0 (n_0), .Y (n_11));
...
module tx_buffer_WORD_SIZE8_NO_OF_WORDS1_1(clk, reset,
  ...
  SDFFQX1 \memory_reg[4] (.CK (clk), .D (n_26), .SI (memory[4]), .SE
       (1'b0), .Q (memory[4]));
  AO22X1 g1302__2683(.A0 (n_18), .A1 (memory[7]), .B0
       (data_parallel_in[7]), .B1 (n_2), .Y (n_34));
