...
build_model \
    -cell	 uart_top \
    -techlib	 ../input/libs/gsclib045/timing/slow_vdd1v0_basicCells.lib \
    -designsource	 $WORKDIR/uart_top.test_netlist.v \
...
build_testmode \
    -testmode	 FULLSCAN \
    -assignfile	 $WORKDIR/uart_top.FULLSCAN.pinassign \
    -modedef	 FULLSCAN \
...
check_log log_create_logic_tests_FULLSCAN_uart_top_atpg
...
check_log log_write_vectors_FULLSCAN_uart_top_atpg
...
check_log log_commit_tests_FULLSCAN_uart_top_atpg
