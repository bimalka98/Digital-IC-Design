...
# 14. Set scan configuration - Exercise
define_scan_chain -name top_chain_a1 -sdi scan_in_a1 -sdo scan_out_a1 -non_shared_output -create_ports -domain clk_a
define_scan_chain -name top_chain_a2 -sdi scan_in_a2 -sdo scan_out_a2 -non_shared_output -create_ports -domain clk_a

define_scan_chain -name top_chain_b1 -sdi scan_in_b1 -sdo scan_out_b1 -non_shared_output -create_ports -domain clk_b
define_scan_chain -name top_chain_b2 -sdi scan_in_b2 -sdo scan_out_b2 -non_shared_output -create_ports -domain clk_b
