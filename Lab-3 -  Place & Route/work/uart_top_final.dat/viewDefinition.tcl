...
create_constraint_mode -name SDC\
   -sdc_files\
    [list uart_top_final.dat/mmmc/modes/SDC/SDC.sdc]
create_analysis_view -name view_fast -constraint_mode SDC -delay_corner dc_fast -latency_file uart_top_final.dat/mmmc/views/view_fast/latency.sdc
create_analysis_view -name view_slow -constraint_mode SDC -delay_corner dc_slow -latency_file uart_top_final.dat/mmmc/views/view_slow/latency.sdc
